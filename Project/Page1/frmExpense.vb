...
Public Class frmExpense
    ...
    Private Sub LoadExpenseTypes()
        Try
            ...
            ' เพิ่มรายการใหม่
            Dim expenseTypes As String() = {"ค่าเช่าสำนักงาน", "เงินสมทบ", "เงินประกันความเสี่ยง", "ค่าตอบแทน", "ค่าจ้าง", "เงินกู้", "สมาชิกลาออก", "ดอกเบี้ยสัจจะ", "อื่นๆ"}
            expenseTypeColumn.Items.AddRange(expenseTypes)
        Catch ex As Exception
    ...
    Private Sub Guna2TextBox2_TextChanged(sender As Object, e As EventArgs) Handles txtDetails.TextChanged
    ...
    Private Sub txtDescrip_TextChanged(sender As Object, e As EventArgs)
    ...
    Private Sub lblTotalAmount_Click(sender As Object, e As EventArgs)
    ...
    Private Sub btnCalculate_Click_1(sender As Object, e As EventArgs)
